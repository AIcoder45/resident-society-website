    ...
    <div className="relative">
      <Lightbox
        ...
        render={{
          ...
          // Hide default close button since we're using custom toolbar
          buttonClose: () => null,
        }}
        styles={{
      ...
      />
      {/* Custom toolbar overlay with title + optional social links */}
      <div className="pointer-events-none fixed top-0 left-0 right-0 z-[10000] flex items-start justify-between px-3 py-3">
        {/* Left: Title */}
        {title && (
